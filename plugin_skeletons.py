    ...
    def execute(self, context):
        ...
        for key, val in dt.items():
            ...
            bpy.context.collection.objects.link(
                armature_object
            )  # this is where obj is introduced in \
...
class CreateArmature:
    ...
    def get_global_pos(
        self, item, dt
    ):  # dt = desc_dict['ske_desc'][skeleton_id]['rb_name']
        total_pos = [0, 0, 0]
        current_bone = item
    ...
    def adding_armature_entry(
        ...
        new_entry = {
            ...
            ls[0]: [
                self.get_parent(id, ls[0]),
                self.get_head(id, ls[0]),
                self.get_tail(id, ls[0]),
                180,
                True,
            ],
            ls[1]: [
                self.get_parent(id, ls[1]),
                self.get_head(id, ls[1]),
                self.get_tail(id, ls[1]),
                180,
                True,
            ],
            ls[2]: [
                self.get_parent(id, ls[2]),
                self.get_head(id, ls[2]),
                self.get_tail(id, ls[2]),
                180,
                True,
            ],
            ls[3]: [
                self.get_parent(id, ls[3]),
                self.get_head(id, ls[3]),
                self.get_tail(id, ls[3]),
                180,
                True,
            ],
            ls[4]: [
                self.get_parent(id, ls[4]),
                self.get_head(id, ls[4]),
                self.create_tail(id, ls[4]),
                180,
                True,
            ],
            ls[5]: [
                self.get_parent(id, ls[5]),
                self.get_head(id, ls[5]),
                self.get_tail(id, ls[5]),
                -90,
                False,
            ],
            ls[6]: [
                self.get_parent(id, ls[6]),
                self.get_head(id, ls[6]),
                self.get_tail(id, ls[6]),
                -90,
                True,
            ],
            ls[7]: [
                self.get_parent(id, ls[7]),
                self.get_head(id, ls[7]),
                self.get_tail(id, ls[7]),
                -90,
                True,
            ],
            ls[8]: [
                self.get_parent(id, ls[8]),
                self.get_head(id, ls[8]),
                self.create_tail(id, ls[8]),
                -90,
                True,
            ],
            ls[9]: [
                self.get_parent(id, ls[9]),
                self.get_head(id, ls[9]),
                self.get_tail(id, ls[9]),
                -90,
                False,
            ],
            ls[10]: [
                self.get_parent(id, ls[10]),
                self.get_head(id, ls[10]),
                self.get_tail(id, ls[10]),
                -90,
                True,
            ],
            ls[11]: [
                self.get_parent(id, ls[11]),
                self.get_head(id, ls[11]),
                self.get_tail(id, ls[11]),
                -90,
                True,
            ],
            ls[12]: [
                self.get_parent(id, ls[12]),
                self.get_head(id, ls[12]),
                self.create_tail(id, ls[12]),
                -90,
                True,
            ],
            ls[13]: [
                self.get_parent(id, ls[13]),
                self.get_head(id, ls[13]),
                self.get_tail(id, ls[13]),
                180,
                False,
            ],
            ls[14]: [
                self.get_parent(id, ls[14]),
                self.get_head(id, ls[14]),
                self.get_tail(id, ls[14]),
                180,
                True,
            ],
            ls[15]: [
                self.get_parent(id, ls[15]),
                self.get_head(id, ls[15]),
                self.get_tail(id, ls[15]),
                -180,
                True,
            ],
            ls[16]: [
                self.get_parent(id, ls[16]),
                self.get_head(id, ls[16]),
                self.create_tail(id, ls[16]),
                -180,
                True,
            ],
            ls[17]: [
                self.get_parent(id, ls[17]),
                self.get_head(id, ls[17]),
                self.get_tail(id, ls[17]),
                180,
                False,
            ],
            ls[18]: [
                self.get_parent(id, ls[18]),
                self.get_head(id, ls[18]),
                self.get_tail(id, ls[18]),
                180,
                True,
            ],
            ls[19]: [
                self.get_parent(id, ls[19]),
                self.get_head(id, ls[19]),
                self.get_tail(id, ls[19]),
                -180,
                True,
            ],
            ls[20]: [
                self.get_parent(id, ls[20]),
                self.get_head(id, ls[20]),
                self.create_tail(id, ls[20]),
                -180,
                True,
            ],
        }
